...
import { DeleteCustomPlayerResponse } from "models/api/custom-entities-api";
...
export const handler: Handler = async (
	...
	const playerUUID = event.pathParameters?.playerUUID || "";

	try {
		if (!playerUUID) {
			const response: DeleteCustomPlayerResponse = {
				success: false,
